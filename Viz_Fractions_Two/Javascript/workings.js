...
function shape1(){
    ...
    localStorage.setItem("practice_title", "Viz_FractionsTwo" + title[0])
...
function shape2(){
    ...
    localStorage.setItem("practice_title", "Viz_FractionsTwo" + title[1])
...
function shape3(){
    ...
    localStorage.setItem("practice_title", "Viz_FractionsTwo" + title[2])
    document.location.href = "game.php"
